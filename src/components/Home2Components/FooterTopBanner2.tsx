...
const FooterTopBanner2 = () => {
  return (
    <div className="shadow-none bg-[#04A7B6]">
      <div className="border-b border-white/30">
        <HalfTemplate>
          <div className="h-56 w-full  flex items-center flex-wrap lg:flex-nowrap  px-4 2xl:px-0 justify-between">
            {/* left side */}
              ...
              <div className="flex items-center gap-3">
                <div className="border-white text-white border-1 md:w-96 p-3 rounded-xl">
                  <input
                    ...
                    className="outline-none border-white text-white placeholder:text-white"
                  />
                </div>
                <button className="font-bold text-[17px] text-white bg-[#F7C121] px-8 py-3 rounded-3xl">
                  Subscribe
                </button>
              </div>
...
export default FooterTopBanner2;
