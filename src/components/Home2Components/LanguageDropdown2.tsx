...
const LanguageDropdown2: React.FC = () => {
  ...
  return (
    <div
      ref={dropdownRef}
      className="relative lg:hidden xl:inline-block border-l border-gray-300 pl-2 mr-1 "
    >
      <button
      ...
      {open && (
        <ul className="absolute left-0 mt-2 w-28 border-none bg-white text-black shadow-md border rounded z-10">
          {languages.map((lang) => (
            <li
              key={lang.code}
