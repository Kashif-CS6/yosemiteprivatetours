  ...
  return (
    <div className=" flex items-center justify-between py-4">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="bg-gray-100 flex items-center px-4 gap-2 w-80 h-[50px] rounded-3xl">
      ...
      <div className="flex items-center gap-5 font-[400]">
        ...
        <LanguageDropdown />
        <button className="bg-black text-white flex items-center px-5 gap-2 py-2 rounded-3xl">
          {" "}
